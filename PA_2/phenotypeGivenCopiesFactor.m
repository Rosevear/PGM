...
for i = 1:size(assignments, 1)
    ...
    curGenotypeID = allelesToGenotypes(curAssignment(2), curAssignment(3));
    curGenotypeAlpha = alphaList(curGenotypeID);
    if curAssignment(1) == 1
        phenotypeFactor = SetValueOfAssignment(phenotypeFactor, curAssignment, curGenotypeAlpha);
    else
        phenotypeFactor = SetValueOfAssignment(phenotypeFactor, curAssignment, 1 - curGenotypeAlpha);
    end
end
