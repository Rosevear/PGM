...
for i = 1:size(assignments, 1)
    ...
    if ((curAssignment(1) == 1) && (curAssignment(2) ~= 3)) || ((curAssignment(1) == 2) && (curAssignment(2) == 3))
        phenotypeFactor = SetValueOfAssignment(phenotypeFactor, curAssignment, 1);
    else
        phenotypeFactor = SetValueOfAssignment(phenotypeFactor, curAssignment, 0);
    end
end

if isDominant == 0
    phenotypeFactor.val = not(phenotypeFactor.val);
end
end
