...
for i = 1:size(assignments, 1)
    ...
    if currentAssignment(1) == 1
        phenotypeFactor = SetValueOfAssignment(phenotypeFactor, currentAssignment, alphaList(alphaListIndex));
    else
        phenotypeFactor = SetValueOfAssignment(phenotypeFactor, currentAssignment, 1 - alphaList(alphaListIndex));
        alphaListIndex = alphaListIndex + 1;
    end
end
end
