...
for i = 1:size(assignments, 1)
    ...
    newCFactorValue = GetValueOfAssignment(A, IndexToAssignment(indxA(i), A.card)) .* GetValueOfAssignment(B, IndexToAssignment(indxB(i), B.card));
    C = SetValueOfAssignment(C, curAssignment, newCFactorValue);    
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
end
end
