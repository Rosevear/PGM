...
% 
%   I = AssignmentToIndex(A, D) Gives the index of the val vector to which
%   the output of the variables A, once passed into the factor, will
%   output, assuming cardinality D for the variables
%   A = IndexToAssignment(I, D) Gives the variables whose output, once they
%   are passed into the factor, will be mapped to the Index I, assuming
%   cardinality D for the variables.
%
