...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 for i = 1:size(assignments, 1)
     curAFactorAssignment = assignments(i, :);
     curAFactorAssignmentValue = GetValueOfAssignment(A, curAFactorAssignment);
     curBFactorAssignment = IndexToAssignment(indxB(i), B.card);
     B = SetValueOfAssignment(B, curBFactorAssignment, GetValueOfAssignment(B, curBFactorAssignment) + curAFactorAssignmentValue);
 end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
end
