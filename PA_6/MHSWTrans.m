...
if variant == 1
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    LogR = log(repmat(1 / d, 1, length(LogR)));
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif variant == 2
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % YOUR CODE HERE
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
labelSelectionProbRatio = LogR(old_value) - LogR(new_value);
qRatio = log_QY_ratio + labelSelectionProbRatio;
stationaryDistRatio = LogProbOfJointAssignment(F, A_prop) - LogProbOfJointAssignment(F, A);
acceptanceProbRatio = stationaryDistRatio + qRatio;

p_acceptance = min(1, exp(acceptanceProbRatio));
