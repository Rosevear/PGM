...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
proposalDistLogProb = log(1 / prod(G.card));

acceptanceNumerator = LogProbOfJointAssignment(F, A_prop) + proposalDistLogProb;
acceptanceDenominator = LogProbOfJointAssignment(F, A) + proposalDistLogProb;

p_acceptance = min(1, exp(acceptanceNumerator - acceptanceDenominator));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
